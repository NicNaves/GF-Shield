...
public class SymmetricalUncertaintyController {
    ...
    private final SymmetricalUncertaintyService symmetricalUncertaintyService;
    ...
    public ResponseEntity<Map<String, String>> processGainRation(
        ...
        try {
            ...
            DataSolution dataSolution = symmetricalUncertaintyService.doRelief(
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(METRICS_FILE_NAME, true))) {
                ...
                for (int generation = 0; generation < maxGenerations; generation++) {
                    symmetricalUncertaintyService.GenerationSolutions(dataSolution, sampleSize, writer, trainingDataset, testingDataset, classifier);
                    symmetricalUncertaintyProducer.send(dataSolution);
